...
#'   \item `obs.bin` binary observations (0 or 1), obs[i] = 1 indicates that the temperature of year i exceeded the temperature year i-1
#'   \item `ens.bin` binary ensemble forecast (each member is either 0 or 1), ens[i, j] = 1 indicates that the j-th ensemble member in year i exceeded the observed temperature of year i-1
